...
- 由于 three.js 官方的编辑器难易拓展维护，不适宜国内开发环境的进行。
- 由于市面上暂时未发现效益较好的 web3D 编辑器类项目。
- 很多中小公司能接到相关的业务但是没有落地的技术和能力或者相关软件项目的基础建设。
...
就是官方不在继续**主动**更新此编辑器的功能，包括 bug 修复，功能新增，文档与演示更新。

### 为什么会停止主动维护？

首先当初开源编辑器项目的首要因素是因为很多中小企业能够接到相关的业务，但是在技术与基建方面，开发成本方面遇到很多困难，作者从互惠互利的角度考虑，开源一个通用版本，各需要企业通过业务修改供自己使用，使自己能够进行业务的落地和过渡，进而反补此项目，又因为是公开平台，参与的企业应该会很多（据作者的直接统计不下 3,40 家），进而能够平摊项目成本，达到一个良性循环，包括项目的资金以及项目的完善程度。

然而理想很丰满，现实很残酷。

1、没有人主动提交 pr，就算是通过私信以及 issue 提出问题后，乃至本身以解决了问题，也没有提交修复版本 pr。
2、暂时没有人或者企业愿意长期资金或者人力支持开源。大家都喜欢一手买卖，达到目的之后不管后续，这个其实无可厚非，但是结果其实可想而知。

### 停止主动维护并不是不再维护。

反者道之动也，既然一如既往的开源模式在当前的环境下只能致开源于死地，那么我们就需要更换模式，就像上面的开源说明最后一条一样。所以此项目的推动模式不在是由官方主导的模式，而是变成由市场主导的模式。
...
1、首先去历史 issue 中开启全部查找,目前包括 2 个平台:[github](https://github.com/Shiotsukikaedesari/three-vis-display-editor/issues)、[gitee](https://gitee.com/Shiotsukikaedesari/three-vis-display-editor/issues)，这样可以避免重复提问。
...
6、如果您选择资金赞助的模式，您会被录入本项目的赞助名单中；如果您选择的是提交代码或者文档，并通过审核，您会被自动录入本项目的贡献者名单中，并享有贡献者的相关权益。
...
**开发收益**：1、如果您完成了相关的 issue，并且这个 issue 是属于**付费赞助支持**部分的，您将收到此 issue 的**全额赞助费用**，收益模式可根据上方**赞助模式**和**模式举例**进行。2、如果有用户购买**付费版本**的 license，您会根据您**提交的代码权重**获得相应的费用。
